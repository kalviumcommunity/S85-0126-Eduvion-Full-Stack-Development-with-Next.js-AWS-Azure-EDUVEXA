     ...
     <div className="backdrop-blur-2xl bg-white/60 dark:bg-gray-900/70 shadow-2xl rounded-[2.5rem] border border-gray-100 dark:border-gray-800 p-10 w-full max-w-md mx-auto relative overflow-hidden ring-1 ring-purple-100 dark:ring-purple-900/30">
        ...
        <div className="relative z-10 space-y-12">
          <div className="text-center space-y-2">
            <h1 className="text-4xl font-black text-gray-900 dark:text-white tracking-tight drop-shadow-lg bg-gradient-to-r from-purple-600 via-blue-500 to-pink-500 bg-clip-text text-transparent">Sign in to EDUVEXA</h1>
            <p className="text-lg text-gray-600 dark:text-gray-300 font-medium">Access your workspace and start learning</p>
          </div>
